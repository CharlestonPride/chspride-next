    ...
    <Layout title="Charleston Pride Pageant: Renaissance Ball">
      <ExternalFrame
        title="Charleston Pride Pageant:
              Renaissance Ball"
        color="primary"
        iframeSrc="https://registration.planningpod.com/?ssid=NTkxNDk4"
        iframeHeight="2000px"
      >
        <Row>
          <Col xs="10" lg="6" className="mx-auto py-5 text-lg-left text-center">
            ...
            <ul className="list-group">
              ...
              <li className="list-group-item">
                ...
                Registration: <strong>$100</strong> through Wednesday, September
                7, 2022. Afterwards, <strong>$150</strong>.
              </li>
            </ul>
          </Col>
          <Col
...
export default PageantRegistration;
